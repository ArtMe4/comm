...
btnForm.onclick = function() {
  ...
  // Установка нового значения для подсчета комментов
  if (countComments == 0)
  ...
  document.querySelector("#comments")
    .insertAdjacentHTML('afterbegin', newComment); // вставка коммента в начало блока, т.е. чем новее написан комент тем он выше
